  ...
  return (
    <div className="relative bg-bg">
      ...
      <div id="about-hero" className="sticky top-0 z-10">
        <section className="relative min-h-screen flex flex-col pt-20 bg-bg">
          ...
          <div className="mx-auto max-w-6xl w-full px-6 py-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="space-y-8">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-cream">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
                  <Button
                    size="md"
                    className="rounded-pill focus-visible:ring-0 bg-accent text-black hover:brightness-95 h-11 px-8 text-sm font-normal tracking-wide"
                  >
                    Contact US
                  </Button>
                  <Button
                    size="md"
                    variant="ghost"
                    className="rounded-pill focus-visible:ring-0 bg-black text-white hover:bg-black/80 h-11 px-8 text-sm font-normal tracking-wide border border-white/20"
                  >
                    Learn More
                  </Button>
                </div>
          ...
          <div className="mx-auto max-w-6xl w-full px-6 pb-16">
            <div className="relative overflow-hidden rounded-3xl bg-surface/30 min-h-[400px] flex items-center justify-center">
          ...
          <div className="mx-auto max-w-6xl w-full px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-sm bg-gray-300 h-[600px] lg:h-[700px] flex items-center justify-center">
              ...
              <div className="flex flex-col space-y-6 justify-center">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extralight tracking-tight text-black whitespace-nowrap">
      ...
      <div id="about-who-we-serve" className="sticky top-0 z-30">
        <section className="relative bg-black py-32 min-h-screen flex items-center">
          <div className="mx-auto max-w-6xl w-full px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="relative grid grid-cols-12 gap-4">
                  ...
                  <div className="col-span-7 relative overflow-hidden rounded-2xl bg-gray-700 h-80">
                  ...
                  <div className="col-span-5 relative overflow-hidden rounded-2xl bg-gray-700 h-72 mt-8">
                    <div className="w-full h-full bg-gray-600 flex items-center justify-center">
                      <p className="text-gray-400 text-sm font-light">
                        Computer Image
                      </p>
                  ...
                  <div className="col-span-8 col-start-3 relative overflow-hidden rounded-2xl bg-gray-700 h-96 -mt-12">
                    <div className="w-full h-full bg-gray-600 flex items-center justify-center">
                      <p className="text-gray-400 text-sm font-light">
                        Desk Work Image
                      </p>
              ...
              <div className="space-y-6">
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-extralight tracking-tight text-white leading-tight">
                  Who We Serve
                </h2>

                <p className="text-sm md:text-base text-white/70 leading-relaxed font-light max-w-lg">
                ...
                <div className="space-y-4 max-w-lg">
                  <div>
                    <h3 className="text-base md:text-lg text-white font-normal mb-2">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  <Button
                    size="md"
                    variant="ghost"
                    className="rounded-pill focus-visible:ring-0 bg-white text-black hover:bg-white/90 h-11 px-8 text-sm font-normal tracking-wide border-0"
                  >
                    Book a call
                  </Button>
                </div>
        ...
        <section className="relative bg-cream py-32 min-h-screen flex items-center">
          <div className="mx-auto max-w-6xl w-full px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <p className="text-xs md:text-sm font-medium tracking-wider uppercase text-brand-deep">
                    Our Methodology
                  </p>

                  <h2 className="text-4xl sm:text-5xl md:text-6xl font-medium tracking-tight text-black leading-tight">
                    Our Approach
                  </h2>
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Button
                      size="md"
                      className="rounded-pill focus-visible:ring-0 bg-black text-white hover:bg-black/90 h-11 px-8 text-sm font-normal tracking-wide border-0"
                    >
                      Learn More
                    </Button>
                  </div>
        ...
        <section className="relative bg-white py-32">
          <div className="mx-auto max-w-6xl w-full px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Team Member Card 1 */}
              <div className="relative overflow-hidden rounded-sm bg-gray-200 h-[600px] group">
              ...
              {/* Quote Card */}
              <div className="relative overflow-hidden rounded-sm bg-[#E8F5E9] p-8 h-[600px] flex flex-col justify-between">
                <div className="space-y-6">
